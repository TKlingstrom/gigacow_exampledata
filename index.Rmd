...
#  summarise(count = n_distinct(SE_Number), .groups = 'drop')
  summarise(nrGigacow_Cow = count(Del_Cow_Id), nrAnimals = n_distinct(SE_Number))
...
#  summarise(count = n_distinct(SE_Number), .groups = 'drop')
  summarise(nrMilkings = count(Del_Cow_Id), nrAnimals = n_distinct(SE_Number))
...
#  summarise(count = n_distinct(Feed_Id), .groups = 'drop') #%>%
#  summarise(count = n_distinct(SE_Number), .groups = 'drop')
  summarise(nrMilkings = count(EquipmentName), nrAnimals = n_distinct(SE_Number))
...
#The below code chunks run an SQL query on each table and then downloads the result.
MilkOther_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "MilkOther_DataView")) %>%
...
#  summarise(count = n_distinct(Activity_Id), .groups = 'drop') #%>%
#  summarise(count = n_distinct(SE_Number), .groups = 'drop')
  summarise(nrActivity = count(dwh_factCowActivity_Id), nrAnimals = n_distinct(SE_Number))
...
#  summarise(count = n_distinct(Feed_Id), .groups = 'drop') #%>%
#  summarise(count = n_distinct(SE_Number), .groups = 'drop')
  summarise(nrFeed = count(dwh_factCowFeed_Id), nrAnimals = n_distinct(SE_Number))
...
#The below code chunks run an SQL query on each table and then downloads the result.
BCS_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Health_BCS_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Health_DiagnosisTreatment_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Health_DiagnosisTreatment_DataView")) %>%
  slice_sample(n = 100)
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_Abortion_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_Abortion_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_Calving_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_Calving_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_DryOff_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_DryOff_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_Insemination_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_Insemination_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_Lactation_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_Lactation_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_PregnancyCheck_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_PregnancyCheck_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Reproduction_ReproductionStatus_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Reproduction_ReproductionStatus_DataView")) %>%
...
#The below code chunks run an SQL query on each table and then downloads the result.
Stillborn_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Stillborn_DataView")) %>%
  slice_sample(n = 100)
...
#The below code chunks run an SQL query on each table and then downloads the result.
Traffic_Con <- con %>% tbl(in_catalog("Gigacow", "sciDel", "Traffic_DataView")) %>%
  slice_sample(n = 100)
